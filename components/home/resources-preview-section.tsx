...
const resources = [
  {
    ...
    description: "Con OxyPulse, AMCS pasó de Excel y carpetas compartidas a trazabilidad total en menos de dos meses.",
    metrics: ["+152% OTs registradas", "+31.4% preventivo", "100% visibilidad"],
    href: "/casos/amcs-digitalizacion-mantenimiento",
    cta: "Leer caso completo",
  },
  {
    tag: "Artículo",
    industry: "Planificación",
    tagColor: "#4361ee",
    ...
    metrics: ["OxyPlanner", "Metalmecánica", "IA Industrial"],
  ...
  },
  {
    ...
    metrics: ["CMMS", "Preventivo", "Correctivo"],
